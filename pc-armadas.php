...
<div class="container" style="padding: 40px 0;">
    <h2 class="section-title">PC Armadas</h2>
    <p>Aquí irán los productos filtrados de esta categoría.</p>
    
    <!-- Puedes copiar el código de las cards (productos) que ya tienes en el index y pegarlas aquí -->
    <!--copiando la estructura de producto de index.php-->
...
<div class="row">
    ...
    <!-- hasta aqui se copio la estructura de producto de index.php, se puede seguir copiando mas productos si se desea -->
